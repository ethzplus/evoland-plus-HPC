...
To download the app image via console, use the following command:

```bash
wget https://dinamicaego.com/nui_download/1792/ -O dinamica-ego.AppImage
```
...
These are collected in the folder
[`src/environments`](https://github.com/cbueth/Future-EI/tree/main/src/environments).
