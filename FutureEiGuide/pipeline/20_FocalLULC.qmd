...
[`20_focal_statistics::simulated_lulc_to_predictors`](https://github.com/cbueth/Future-EI/blob/main/src/steps/20_FocalLULC/20_focal_statistics.R#L260-L323).
...
[`src/steps/20_FocalLULC/20_FocalLULC_setup.sh`](https://github.com/cbueth/Future-EI/tree/main/src/steps/20_FocalLULC/20_FocalPrep_setup.sh).

As for the previous steps, the job script
[`slurm_job.sh`](https://github.com/cbueth/Future-EI/tree/main/src/steps/20_FocalLULC/slurm_job.sh)
