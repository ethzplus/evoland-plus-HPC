...
[`src/steps/11_CheckLULCC/11_CheckLULCC_setup.sh`](https://github.com/cbueth/Future-EI/tree/main/src/steps/11_CheckLULCC/11_CheckLULCC_setup.sh)
...
the job script
[`slurm_job.sh`](https://github.com/cbueth/Future-EI/tree/main/src/steps/11_CheckLULCC/slurm_job.sh).
