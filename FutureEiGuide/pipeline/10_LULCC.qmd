...
as well as an adapted version for use with Future-EI,
...
Our Dockerfile [`src/steps/10_LULCC/Dockerfile`](https://github.com/cbueth/Future-EI/tree/main/src/steps/10_LULCC/Dockerfile)
then adds the necessary R packages for LULCC to the container.
The Apptainer Definition
File [`src/steps/10_LULCC/lulcc.def`](https://github. com/cbueth/Future-EI/tree/main/src/steps/10_LULCC/lulcc.def)
...
[`src/steps/10_LULCC/docker_setup.sh`](https://github.com/cbueth/Future-EI/tree/main/src/steps/10_LULCC/docker_setup.sh)
script, which uses variables from the
[`src/config.yml`](https://github.com/cbueth/Future-EI/tree/main/src/config.yml).
